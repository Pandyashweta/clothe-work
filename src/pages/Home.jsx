    ...
    <div className="home-page main-content">
      ...
      <section className="categories-section container">
        ...
        <div className="categories-grid">
          ...
          <div className="category-card" onClick={handleShopClick}>
            <div className="category-img-wrapper">
              <img src="/images/product_dress1.png" alt="Dresses" className="category-img" />
            </div>
          ...
          <div className="category-card" onClick={handleShopClick}>
            <div className="category-img-wrapper">
              <img src="/images/product_dress2.png" alt="Swimwear" className="category-img" />
            </div>
            <div className="category-label">
              <span>SWIMWEAR</span>
            </div>
          ...
          <div className="category-card" onClick={handleShopClick}>
            <div className="category-img-wrapper">
              <img src="/images/product_dress4.png" alt="New In" className="category-img" />
            </div>
            <div className="category-label">
              <span>CO-ORDS</span>
            </div>
